...
## Github Repo
![](qr.svg){fig.align='center' width=200px}
...
2. [Quarto Docs – Parameters](https://quarto.org/docs/computations/parameters.html)
3. [Quarto Params Example – Jade Ryan](https://jadeyryan.quarto.pub/rladies-abuja-quarto-params/)
